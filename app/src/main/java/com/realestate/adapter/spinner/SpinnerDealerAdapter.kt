 ...
 */
class SpinnerDealerAdapter(context: Context, dealerList: List<DealerModel>) :
    ArrayAdapter<DealerModel>(context, 0, dealerList) {
    private var dealerList: List<DealerModel>
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        var dealer = getItem(position) as DealerModel
        val view: View
        val vh: ItemHolder
        if (convertView == null) {
        ...
        vh.simple_txt.text = dealer.dealerNo
        /*if (position == 0) {
    ...
    override fun getItem(position: Int): DealerModel? {
        return dealerList[position]
    }
