 ...
 */
class SpinnerVehicleAdapter(context: Context, vehicleList: List<VehicleModel>) :
    ArrayAdapter<VehicleModel>(context, 0, vehicleList) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        var vehicle = getItem(position) as VehicleModel
        val view: View
        val vh: ItemHolder
        if (convertView == null) {
        ...
        vh.simple_txt.text = vehicle.vehicleRegisteredNo
        /*if (position == 0) {
    ...
    override fun getItem(position: Int): VehicleModel? {
